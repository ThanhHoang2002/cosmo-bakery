...
import { GENDER_DISPLAY } from '@/constant/gender';
      ...
      <TableCell>
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-sm capitalize">{GENDER_DISPLAY[customer.gender.toUpperCase() as keyof typeof GENDER_DISPLAY]}</span>
          </div>
        </div>
      </TableCell>
      <TableCell>
        ...
        >
          {ROLES_DISPLAY[customer.role.name.toUpperCase() as keyof typeof ROLES_DISPLAY]}
        </Badge>
      </TableCell>
      <TableCell>
        <div className="flex items-center gap-1">
